...
Six jobs, two parallel tracks, 58 seconds total. Security scanning runs alongside the build — not before it — so neither blocks the other.

<img width="1575" height="541" alt="Screenshot 2026-05-17 151234" src="https://github.com/user-attachments/assets/a266f4de-795d-493d-b0ad-4d5a9c239d08" />


### Argo CD — all three apps Healthy + Synced
GitOps in practice: every `git push` triggers a webhook, Argo CD diffs the cluster state against the repo, and syncs automatically. No `kubectl apply` in the pipeline.

<img width="1551" height="606" alt="Screenshot 2026-05-17 145235" src="https://github.com/user-attachments/assets/292bcc40-863c-4812-b3c0-859815718656" />

### Live cluster — pods, services, HPA
All three workloads running, HPA watching the backend at 1%/80% CPU (scales 1→4 replicas under load), StatefulSet mysql stable at 7h+ uptime.

<img width="1293" height="814" alt="Screenshot 2026-05-17 151059" src="https://github.com/user-attachments/assets/96b6ce89-3808-4069-a9c7-2fc28822b6cf" />

### Grafana — Kubernetes Compute Resources
kube-prometheus-stack deployed via Argo CD. The `skillpulse` namespace shows 3 pods, 3 workloads, 428 MiB memory — real metrics from the running cluster, not a mock dashboard.

<img width="1779" height="1020" alt="Screenshot 2026-05-17 105805" src="https://github.com/user-attachments/assets/76163719-ada3-4838-a660-50136a6052c1" />
